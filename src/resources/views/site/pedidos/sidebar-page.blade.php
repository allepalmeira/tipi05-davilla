                        ...
                        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <figure class="image"><a href="shop-single.html"><img src="{{ asset('davilla/images/recipe_8.jpg') }}" alt=""></a></figure>
                            ...
                            <div class="widget-content">
                                ...
                                <div class="shopping-cart">
                                    <ul class="shopping-cart-items">
                                        <li class="cart-item">
                                            <img src="{{ asset('davilla/images/recipe_8.jpg') }}" alt="#" class="thumb" />
