    <!-- Services Section -->
    @php
    $services = asset('davilla/images/services/services-1.png');
    @endphp
                ...
                <div class="service-block">
                    <div class="inner-box">
                        <div class="image-box">
                            ...
                            <!-- cake img -->
                            <figure class="image"><img src="{{ asset("davilla/images/services/services-$linha->id_categoria.svg") }}" alt="{{ $linha->nome_categoria }}"></figure>
                        </div>
